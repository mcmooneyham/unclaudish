...
REMINDERS = {
    ...
    "max": (
        ...
        " prose per reply; code, commands, and tables do not count."
        ...
        " numbers and names. Never use: em dashes (use a colon or"
        " comma), flattery or enthusiasm, (not X, but Y) framing,"
